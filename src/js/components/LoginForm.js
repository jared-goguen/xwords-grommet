...
var LoginForm = function (_Component) {
  ...
  function LoginForm(props, context) {
    ...
    _this._onRegister = _this._onRegister.bind(_this);
  ...
  _createClass(LoginForm, [{
    ...
    key: '_onRegister',
    value: function _onRegister(event) {
      event.preventDefault();
      var onRegister = this.props.onRegister;
      var _state = this.state,
          password = _state.password,
          rememberMe = _state.rememberMe,
          username = _state.username;
      ...
      if (onRegister) {
        onRegister({ username: username, password: password, rememberMe: rememberMe });
      }
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var register = _react2.default.createElement(_FormattedMessage2.default, { id: 'Register', defaultMessage: 'Register' });
